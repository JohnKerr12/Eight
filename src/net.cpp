...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Piece of Eight " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"piece of eighttools.com", "dnsseed.piece of eighttools.com"},
    {"piece of eightpool.org", "dnsseed.piece of eightpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"piece of eighttools.com", "testnet-seed.piece of eighttools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Piece of Eight is probably already running."), addrBind.ToString().c_str());
        else
