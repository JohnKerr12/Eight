...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Piece of Eight: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Piece of Eight: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Piece of Eight: 2.5 minutes
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Piece of Eight: increase each by adding 2 to bitcoin's value.
